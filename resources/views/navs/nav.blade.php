...
<a class="nav-link {{ Route::currentRouteName() == 'company.edit' ? 'active' : '' }}"
    href="{{ route('company.edit') }}">Dane Firmy</a>
<a class="nav-link {{ Route::currentRouteName() == 'invoice.index' ? 'active' : '' }}"
    href="{{ route('invoice.index') }}">Lista Zleceń</a>
<a class="nav-link {{ Route::currentRouteName() == 'invoice.create' ? 'active' : '' }}"
