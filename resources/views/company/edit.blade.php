                    ...
                    <div class="col-12 col-lg-8">
                        ...
                        <form method="POST" action="{{ route('company.update', $company->id) }}" class="pt-5">
                            ...
                            <div class="row g-3 align-items-center mb-3">
                                ...
                                <div class="col-auto">
                                    <input value="{{ $company->name }}" name="name" type="name" class="form-control" id="InputName" aria-describedby="nameHelp">
                                </div>
                            ...
                            <div class="row g-3 align-items-center mb-3">
                                ...
                                <div class="col-auto">
                                    <input value="{{ $company->post_code }}" name="post_code" type="name" class="form-control" id="InputPostCode" aria-describedby="nameHelp">
                                </div>
                            ...
                            <div class="row g-3 align-items-center mb-3">
                                ...
                                <div class="col-auto">
                                    <input value="{{ $company->city }}" name="city" type="name" class="form-control" id="InputCity" aria-describedby="nameHelp">
                                </div>
                            ...
                            <div class="row g-3 align-items-center mb-3">
                                ...
                                <div class="col-auto">
                                    <input value="{{ $company->street }}" name="street" type="name" class="form-control" id="InputStreet" aria-describedby="nameHelp">
                                </div>
                            ...
                            <div class="row g-3 align-items-center mb-3">
                                ...
                                <div class="col-auto">
                                    <input value="{{ $company->number }}" name="number" type="name" class="form-control" id="InputNumber" aria-describedby="nameHelp">
                                </div>
