        ...
        <div class="col-12 col-lg-9">
			...
			<form method="POST" action="{{ route('invoice.update', $invoice->id) }}" class="pt-3">
				...
				<div class="input-group input-group-sm mb-3">
					...
					<input value="{{ $invoice->number }}" readonly name="number" type="text" class="form-control" id="InputNumber">
				</div>
				<div class="input-group input-group-sm mb-3">
					<label for="InputMake" class="input-group-text">Marka Pojazdu</label>
					<input value="{{ old('make') ? old('make') : $invoice->make }}" name="make" type="text" class="form-control" id="InputMake">
				...
				<div class="input-group input-group-sm mb-3">
					...
					<input value="{{ old('model') ? old('model') : $invoice->model }}" name="model" type="text" class="form-control" id="InputModel">
				</div>
				...
				<div class="input-group input-group-sm mb-3">
					...
					<input value="{{ old('registration') ? old('registration') : $invoice->registration }}" name="registration" type="text" class="form-control" id="InputRegistration">
				</div>
				...
				<div class="input-group input-group-sm mb-3">
					...
					<input value="{{ old('vin') ? old('vin') : $invoice->vin }}" name="vin" type="text" class="form-control" id="InputVin">
				</div>
				...
				<div class="input-group input-group-sm mb-3">
					...
					<input value="{{ old('milage') ? old('milage') : $invoice->milage }}" name="milage" type="number" class="form-control" id="InputMilage">
				</div>
					...
					@if(old('jobs.desc'))
						...
						<div data-input-group="jobs" class="row">
							<div class="col-7 px-0 ps-1 px-lg-3 col-lg-8 mb-3">
								<div class="input-group input-group-sm">
									<label for="InputJobDesc" class="input-group-text">Opis</label>
									<input value="{{ $invoice->jobs['desc'][$i] }}" name="jobs[desc][]" type="text" class="form-control" id="InputPartDesc">
								</div>
							</div>
							<div class="col-5 px-0 ps-1 px-lg-3 col-lg-3 mb-3">
								<div class="input-group input-group-sm">
									<label for="InputJobPrice" class="input-group-text">Cena</label>
									<input value="{{ $invoice->jobs['price'][$i] }}" name="jobs[price][]" type="number" class="form-control" id="InputPartDesc">
								</div>
							</div>
							<div class="col-12 px-0 ps-1 px-lg-3 col-lg-1 mb-3 d-flex align-items-center">
								<button data-remove type="button" class="btn btn-sm py-0 btn-danger">Usuń</button>
					...
					@if(old('parts.desc'))
						...
						<div data-input-group="parts" class="row">
							...
							<div class="col-5 px-0 ps-1 px-lg-3 col-lg-2 mb-3">
								<div class="input-group input-group-sm">
									<label for="InputJobPrice" class="input-group-text">Cena</label>
									<input value="{{ old('parts.price.'.$i) ? old('parts.price.'.$i) : '' }}" name="parts[price][]" type="number" class="form-control" id="InputPartDesc">
								</div>
							</div>
							<div class="col-12 px-0 ps-1 px-lg-3 col-lg-1 mb-3 d-flex align-items-center">
								<button data-remove type="button" class="btn btn-sm py-0 btn-danger">Usuń</button>
					...
					@else
						...
						<div data-input-group="parts" class="row">
							<div class="col-7 px-0 ps-1 px-lg-3 col-lg-8 mb-3">
								<div class="input-group input-group-sm">
									<label for="InputJobDesc" class="input-group-text">Opis</label>
									<input value="{{ $invoice->parts['desc'][$i] }}" name="parts[desc][]" type="text" class="form-control" id="InputPartDesc">
								</div>
							</div>
							<div class="col-5 px-0 ps-1 px-lg-3 col-lg-3 mb-3">
								<div class="input-group input-group-sm">
									<label for="InputJobPrice" class="input-group-text">Cena</label>
									<input value="{{ $invoice->parts['price'][$i] }}" name="parts[price][]" type="number" class="form-control" id="InputPartDesc">
								</div>
							</div>
							<div class="col-12 px-0 ps-1 px-lg-3 col-lg-1 mb-3 d-flex align-items-center">
								<button data-remove type="button" class="btn btn-sm py-0 btn-danger">Usuń</button>
